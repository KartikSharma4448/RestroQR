...
export default function MenuContent({ categories }: MenuContentProps) {
  return (
    <CartProvider>
      <MenuContentInner categories={categories} />
      <CartBar />
    </CartProvider>
  );
}

function MenuContentInner({ categories }: MenuContentProps) {
  ...
  return (
    <div className="px-4 pt-4 pb-24">
      ...
      <div className="sticky top-0 z-20 -mx-4 mb-6 border-b border-gray-100 bg-white/95 px-4 py-3 backdrop-blur-md shadow-sm">
      ...
      {noResults && (
        <div className="flex flex-col items-center py-16">
          ...
          <p className="mt-4 text-base font-medium text-gray-700">No items found</p>
      ...
      {!hasActiveFilters && categories.length === 0 && (
        <div className="flex flex-col items-center py-16">
          ...
          <p className="mt-4 text-base font-medium text-gray-700">Menu is being prepared</p>
